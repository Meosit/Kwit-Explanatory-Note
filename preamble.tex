...
% Зачем: Длина, пимерно соответвующая 5 символам
...
% Зачем: поддержка различных цветов подсветки синтаксиса (Kotlin)
\usepackage[dvipsnames]{xcolor}

% Зачем: поддержка многостраничных таблиц
\usepackage{tabularx}
\usepackage{ltablex} 
\usepackage{longtable}

% Зачем: квадратные скобки в списке использованых источников
\usepackage{enumitem}
